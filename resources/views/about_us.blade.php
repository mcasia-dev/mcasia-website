...
<main class="about-page">
    <section class="relative h-[42vh] sm:h-[50vh] lg:h-[62vh] overflow-hidden pt-16 lg:pt-0">
        <img src="{{ asset('images/HOMEPAGE/1.jpg') }}" alt="McAsia Background" class="absolute inset-0 w-full h-full object-cover">
        ...
        <div class="relative z-10 flex items-center justify-center h-full">
            <div class="text-center px-4 sm:px-6 max-w-3xl">
                <h1 class="about-heading text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-3 sm:mb-4" data-aos="fade-down" data-aos-duration="1000">
                    Our Story
                </h1>
                <p class="text-base sm:text-lg lg:text-xl text-gray-200" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
    ...
    <section class="py-12 sm:py-16 lg:py-20">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 space-y-6 sm:space-y-8">
            @foreach ($timelines as $timeline)
                <article class="fade-section story-card bg-white rounded-2xl p-5 sm:p-6 md:p-8 shadow-sm border border-gray-100">
                    <div class="timeline">
                        <span class="timeline-dot"></span>
                        <h3 class="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3">{{ $timeline['title'] }}</h3>
    ...
    <section class="py-12 sm:py-16 lg:py-20 bg-gray-50/90">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                <article class="fade-section story-card bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            We are dedicated to delivering authentic Asian products that satisfy and elevate every Filipino's Asian cravings with uncompromising quality.
                        </p>
                    </div>
                </article>
                ...
                <article class="fade-section story-card bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            To be the leading provider of Asian consumer products, offering authentic taste that uncovers the heart of Asian flavors and beyond.
                        </p>
                    </div>
                </article>
                ...
                <article class="fade-section story-card bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                    <div class="h-44 sm:h-48 overflow-hidden">
                        <img src="{{ asset('images/about_us/3.jpg') }}" alt="Core Values" class="w-full h-full object-cover">
                    </div>
                    <div class="p-5 sm:p-6">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center gap-2">
                        ...
                        <ul class="space-y-2 text-gray-600">
                            <li class="flex items-start gap-2"><i class="fa-solid fa-check text-teal-600 mt-1"></i><span>Excellence in everything we do</span></li>
                            <li class="flex items-start gap-2"><i class="fa-solid fa-check text-teal-600 mt-1"></i><span>Customer Commitment</span></li>
                            <li class="flex items-start gap-2"><i class="fa-solid fa-check text-teal-600 mt-1"></i><span>Integrity in all dealings</span></li>
                            <li class="flex items-start gap-2"><i class="fa-solid fa-check text-teal-600 mt-1"></i><span>Teamwork and collaboration</span></li>
                            <li class="flex items-start gap-2"><i class="fa-solid fa-check text-teal-600 mt-1"></i><span>Sustainable practices</span></li>
                        </ul>
                    </div>
                </article>
            </div>
