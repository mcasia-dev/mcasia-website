    ...
    <main class="bg-slate-50">
        <section class="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
            <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div
                    class="border-b border-slate-200 bg-gradient-to-r from-slate-900 to-slate-700 px-6 py-8 text-gray-900 sm:px-10">
                ...
                <div
                    class="px-6 py-8 md:px-10 md:py-10 [&_a]:break-words [&_a]:text-blue-700 [&_a]:underline [&_h2]:mb-4 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-slate-900 [&_h3]:mb-3 [&_h3]:mt-8 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-slate-900 [&_ol]:mb-8 [&_ol]:space-y-1 [&_ol]:pl-5 [&_p]:mb-4 [&_p]:text-justify [&_p]:text-sm [&_p]:leading-loose [&_p]:text-slate-700 sm:[&_p]:text-base">

                    <!-- Introduction -->
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        <span class="font-semibold">Agreement to Our Legal Terms</span><br>
                        We are McAsia Foodtrade Corporation (“Company,” “we,” “us,” “our”), a company registered in the
                        Philippines at 158 Apo St. Sta Mesa Heights Maharlika, Quezon City.
                    </p>

                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        We operate the website <a href="http://www.mcasiafoodtrade.ph" class="text-blue-600 underline">http://www.mcasiafoodtrade.ph</a>
                        (the “Site”), as well as any other related products and services that refer or link to these
                        legal terms (the “Legal Terms”) (collectively, the “Services”). You can contact us by email at
                        <a href="mailto:customercare@mcasiafoodtrade.ph" class="text-blue-600 underline">customercare@mcasiafoodtrade.ph</a>
                        or by mail to our main office address.
                    </p>

                    <p class="text-gray-700 mb-6">
                        These Legal Terms constitute a legally binding agreement made between you, whether personally or
                        on behalf of an entity (“you”), and McAsia Foodtrade Corporation, concerning your access to and
                        use of the Services. By accessing the Services, you acknowledge that you have read, understood,
                        and agree to be bound by all of these Legal Terms. IF YOU DO NOT AGREE, YOU MUST DISCONTINUE USE
                        IMMEDIATELY.
                    </p>

                    <!-- Table of Contents -->
                    <h2 class="text-xl font-semibold text-gray-800 mb-3">Table of Contents</h2>
                    <ol class="list-decimal list-inside text-gray-700 space-y-1 mb-6">
                        <li>Our Services</li>
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">1. OUR SERVICES</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        The information provided when using the Services is not intended for distribution to or use by
                        any person or entity in any jurisdiction where such use would be contrary to law. Persons
                        accessing the Services from other locations are responsible for compliance with local laws.
                    </p>


                    <!-- Section: Our Services -->
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">2. INTELLECTUAL PROPERTY RIGHTS</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        The information provided when using the Services is not intended for distribution to or use by
                        any person or entity in any jurisdiction where such use would be contrary to law. Persons
                        accessing the Services from other locations are responsible for compliance with local laws.
                    ...
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        ...
                        customercare@mcasiafoodtrade.ph. If we ever grant you the permission to post, reproduce, or
                    ...
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        ...
                        Contributions; and warrant and represent that your Submissions and/or Contributions do not
                        constitute confidential information. You are solely responsible for your Submissions and/or
                        Contributions and you expressly agree to reimburse us for any and all losses that we may suffer
                        because of your breach of (a) this section, (b) any third party’s intellectual property rights,
                        or (c) applicable law.
                    </p>
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">3. USER REPRESENTATIONS</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">4. USER REGISTRATION</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">5. PRODUCTS</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">6. PURCHASES AND PAYMENT</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">7. PROHIBITED ACTIVITIES</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        ...
                        the Services to create or compile, directly or indirectly, a collection, compilation, database,
                        or directory without written permission from us. Trick, defraud, or mislead us and other users,
                        ...
                        enforce limitations on the use of the Services and/or the Content contained therein.Disparage,
                        tarnish, or otherwise harm, in our opinion, us and/or the Services.Use any information obtained
                        from the Services in order to harass, abuse, or harm another person. Make improper use of our
                        ...
                        linking to the Services. Upload or transmit (or attempt to upload or to transmit) viruses,
                        ...
                        features, functions, operation, or maintenance of the Services. Engage in any automated use of
                        the system, such as using scripts to send comments or messages, or using any data mining,
                        robots, or similar data gathering and extraction tools. Delete the copyright or other
                        proprietary rights notice from any Content. Attempt to impersonate another user or person or use
                        the username of another user. Upload or transmit (or attempt to upload or to transmit) any
                        ...
                        bugs, cookies, or other similar devices (sometimes referred to as ``spyware`` or ``passive
                        collection mechanisms`` or ``pcms``). Interfere with, disrupt, or create an undue burden on the
                        ...
                        Services, or any portion of the Services. Copy or adapt the Services' software, including but
                        not limited to Flash, PHP, HTML, JavaScript, or other code. Except as permitted by applicable
                        law, decipher, decompile, disassemble, or reverse engineer any of the software comprising or in
                        any way making up a part of the Services. Except as may be the result of standard search engine
                        or Internet browser usage, use, launch, develop, or distribute any automated system, including
                        without limitation, any spider, robot, cheat utility, scraper, or offline reader that accesses
                        the Services, or use or launch any unauthorized script or other software. Use a buying agent or
                        purchasing agent to make purchases on the Services. Make any unauthorized use of the Services,
                        ...
                        false pretenses. Use the Services as part of any effort to compete with us or otherwise use the
                        Services and/or the Content for any revenue-generating endeavor or commercial enterprise. Use
                        the Services to advertise or offer to sell goods and services.
                    </p>


                    <h3 class="text-lg font-semibold text-gray-800 mb-2">8. USER GENERATED CONTRIBUTIONS</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        ...
                        rights of any third party. You are the creator and owner of or have the necessary licenses,
                        rights, consents, releases, and permissions to use and to authorize us, the Services, and other
                        users of the Services to use your Contributions in any manner contemplated by the Services and
                        these Legal Terms. You have the written consent, release, and/or permission of each and every
                    ...
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        Your Contributions are not false, inaccurate, or misleading. Your Contributions are not
                        ...
                        anyone. Your Contributions are not used to harass or threaten (in the legal sense of those
                        ...
                        not violate the privacy or publicity rights of any third party. Your Contributions do not
                        violate any applicable law concerning child pornography, or otherwise intended to protect the
                        health or well-being of minors. Your Contributions do not include any offensive comments that
                        are connected to race, national origin, gender, sexual preference, or physical handicap. Your
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">9. CONTRIBUTION LICENSE</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">10. GUIDELINES FOR REVIEWS</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">11. SOCIAL MEDIA</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        ...
                        and stored in your Third-Party Account (the ``Social Network Content``) so that it is available
                        on and through the Services via your account, including without limitation any friend lists and
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">12. SERVICES MANAGEMENT</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">13. PRIVACY POLICY</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        We care about data privacy and security. Please review our Privacy Policy:
                        http://www.mcasiafoodtrade.ph/privacy_policy. By using the Services, you agree to be bound by
                        our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services
                        are hosted in the Philippines. If you access the Services from any other region of the world
                        with laws or other requirements governing personal data collection, use, or disclosure that
                        differ from applicable laws in the Philippines, then through your continued use of the Services,
                        you are transferring your data to the Philippines, and you expressly consent to have your data
                        transferred to and processed in the Philippines.
                    </p>


                    <h3 class="text-lg font-semibold text-gray-800 mb-2">14. TERM AND TERMINATION</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">15. MODIFICATIONS AND INTERRUPTIONS</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">16. GOVERNING LAW</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        These Legal Terms shall be governed by and defined following the laws of __________. Mcasia
                        Foodtrade Corporation and yourself irrevocably consent that the courts of __________ shall have
                        exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal
                        Terms.
                    </p>


                    <h3 class="text-lg font-semibold text-gray-800 mb-2">17. CORRECTIONS</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">18. DISCLAIMER</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">19. LIMITATIONS OF LIABILITY</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        ...
                        PAID, IF ANY, BY YOU TO US OR . CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">20. INDEMNIFICATION</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        You agree todefend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">21. USER DATA</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        We will maintaincertain data that you transmit to the Services for the purpose of managing the
                        ...
                        activity you have undertaken using the Services. You agree that we shall have no liability to
                        you for any loss or corruption of any such data, and you hereby waive any right of action
                        against us arising from any such loss or corruption of such data.
                    </p>


                    <h3 class="text-lg font-semibold text-gray-800 mb-2">22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS,
                        AND SIGNATURES</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">23. MISCELLANEOUS</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">24. CONTACT US</h3>
                    <p class="text-gray-700 text-justify mb-4 tracking-wide leading-loose font-general-sans">
                        ...
                        158 Apo St. Sta Mesa Heights Maharlika Quezon City
                    </p>
