    @extends('layouts.app')
    @section('title', 'McAsia - Oat Daily')
    @section('content')
...
<div class="image_slideshow relative w-full overflow-hidden rounded-lg shadow-lg mb-10 bg-white">
  <div id="slideshow" class="w-full h-full relative">
    <img src="{{ asset('images/product_brands/oatdaily/banner.png') }}"
...
<div class="bg-white shadow-lg rounded-xl overflow-hidden flex flex-col hover:shadow-xl transition-shadow">
  ...
  <div class="w-full h-48 bg-gray-100 flex items-center justify-center">
    <img 
      src="{{ asset('images/product_brands/oatdaily/1.png') }}" 
      alt="[Name of title]"
    ...
    <h3 class="text-lg font-semibold text-center text-gray-800 leading-snug">
      OAT DAILY BARISTA EDITION
        ...
        <ul class="list-disc text-justify text-[15px] ml-5 text-gray-600 space-y-1">
          <li>Made to be your mainstay non-dairy milk,</li>
          <li>An oat-based milk that is safe for everyone to consume, including vegetarians and people with lactose intolerance!</li>
          <li>With a not-so-sweet taste</li>
          <li>Suitable to mix with various menus without worrying about changing the flavor!</li>
