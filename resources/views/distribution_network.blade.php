@extends('layouts.app')
@section('title', 'McAsia - Distribution Network')
@section('content')
...
<main class="w-full overflow-x-hidden">
    ...
    <section class="network-hero relative h-[36vh] sm:h-[46vh] lg:h-[58vh] overflow-hidden">
        ...
        <div class="relative z-10 h-full flex items-center justify-center text-center px-4 sm:px-6">
            <div>
                {{-- <h1 class="text-3xl sm:text-4xl lg:text-6xl font-bold text-white">Distribution Network</h1>
                <p class="text-white/90 mt-3 text-sm sm:text-base lg:text-lg max-w-3xl mx-auto">
                    Nationwide logistics designed for timely, secure, and consistent delivery.
                </p> --}}
            </div>
        </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14 lg:py-16 space-y-8 sm:space-y-10">
        <article class="fade-section space-y-4">
            <h2 class="text-2xl sm:text-3xl font-bold text-gray-900">Distribution Network</h2>
            <p class="text-gray-600 leading-relaxed text-justify text-sm sm:text-base">
                Our distribution goes beyond simply delivering products. It is about building seamless connections with
                our partners and customers. We ensure timely and reliable delivery across the Philippines, serving
                retailers, supermarkets, restaurants, e-commerce platforms, and food service establishments. Through a
                strategically managed logistics network and advanced operational systems, we consistently uphold product
                integrity, efficiency, and the highest standards of service, reinforcing MCAsia's reputation as a trusted
                and dependable partner in the food distribution industry.
            </p>
        </article>

        <article class="fade-section space-y-4">
            <h3 class="text-xl sm:text-2xl font-semibold text-gray-900">Technology-Powered Reach</h3>
            <p class="text-gray-600 leading-relaxed text-justify text-sm sm:text-base">
                Leveraging cutting-edge logistics technology and a nationwide delivery network,
                <span class="font-semibold text-gray-800">McAsia Foodtrade Corporation</span> ensures that every
                product reaches its destination safely, efficiently, and on schedule. Our real-time tracking systems,
                optimized delivery routes, and dedicated fleet allow us to respond swiftly to customer demands while
                maintaining the highest standards of product quality and safety. This integrated approach strengthens
                our supply chain and reinforces MCAsia's commitment to reliable service, operational excellence, and
                lasting partnerships across the country.
            </p>
        </article>
