...
@section('content')
    ...
    <div class="relative overflow-hidden min-h-screen">
        ...
        <section class="relative h-screen overflow-hidden"> {{-- Reduced height --}}
            <img src="{{ asset('images/distribution_network/1.jpg') }}" alt="Background" class="image_cover absolute">
        </section>
        ...
        <section class="content_text mx-auto px-4 py-12 space-y-10">
            ...
            <div class="fade-section">
                <h2 class="text-2xl font-bold text-gray-900">Distribution Network</h2>
            </div>
            ...
            <div class="fade-section">
                <p class="text-gray-600 leading-relaxed text-justify">
                    ...
                    We ensure timely and reliable delivery across the Philippines, serving retailers, supermarkets,
                    restaurants, e-commerce platforms, and food service establishments.
                    Through a strategically managed logistics network and advanced operational systems, we consistently
                    uphold product integrity, efficiency, and the highest standards of service, reinforcing MCAsia’s
                    reputation as a trusted and dependable partner in the food distribution industry.
                </p>
            </div>
            ...
            <div class="fade-section">
                <p class="text-gray-600 leading-relaxed text-justify">
                    Leveraging cutting-edge logistics technology and a nationwide delivery network, <span
                        class="font-semibold text-gray-800">McAsia Foodtrade Corporation</span> ensures that every product
                    reaches its destination safely, efficiently, and on schedule.
                    Our real-time tracking systems, optimized delivery routes, and dedicated fleet allow us to respond
                    swiftly to customer demands while maintaining the highest standards of product quality and safety.
                    This integrated approach strengthens our supply chain and reinforces MCAsia’s commitment to reliable
                    service, operational excellence, and lasting partnerships across the country.
                </p>
            </div>
        </section>
        <!------------------------------------------------------------------------------------------------------------------------------->
